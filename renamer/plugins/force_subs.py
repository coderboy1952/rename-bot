...
async def force_sub(c, m):
    if Config.FORCE_SUB:
        try:
            ...
            button = [[InlineKeyboardButton('Visit➡️➡️', url=f'https://t.me/{Config.FORCE_SUB}')]]
            markup = InlineKeyboardMarkup(button)
            return await m.reply_text(text="Hey!! Join the movie channel to use me...😇", parse_mode='markdown', reply_markup=markup, quote=True)
